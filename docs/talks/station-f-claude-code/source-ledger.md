...
| 11 | `claude-getting-started-with-loops` | Anthropic | 21, 23 | **S35 + S37** | — |
| 12 | `react-paper` | arXiv 2210.03629 | 10 | **S13** | — |
| 13 | `anthropic-agent-skills` | Anthropic | 17 | **S21** | Pairs with the new WikiSkill evidence on S50. |
...
| 22 | `meta-production-evals` | Meta MSL (Gupta) | 19 | **S45** | — |
| 23 | `hamel-evals` | Hamel Husain | 20 | **S46 + A03** | — |
...
| `anthropic.com/research/building-effective-agents` | 37 | S34 | Exact page + quote (this one is already precise). |
| `mistral.ai`, `help.mistral.ai`, `scaleway.com` | 7, 35 | S09 + A01 | Exact pages + quotes. |
| Karpathy `autoresearch` repo + nanochat +11% | 22 | S38 | Two separate stories — keep attributed separately (see heuritech `sources-and-speakers.md`). |
| Stripe migration "1 day vs 2 months" | 23 | S37 | Vendor launch-day testimonial. Ship only with that caveat stated, or cut. |
| Steinberger loops post · Cherny `/loop` | 21 | S35 | Exact post URLs. |
...
| `tweet-…-nanogpt-prime-intellect.md` | 153 runs / 18 models; 82% of the gap; no new method | **S11 + S38** | Cite the Prime Intellect blog + leaderboard, not the tweet. |
...
| `tweet-…-dair-wikiskill.md` | WikiSkill: +12.3/17.5/23.9%; 9B+skills 47.4% > 27B 39.4% | **S50** | Cite arXiv:2608.27454 directly. Preprint caveat travels. |
| `tweet-…-femke-company-brain.md` | 9 systems, 4 shared parts | **S52** | Vendor marketing — per-system primaries needed (brief). Slite survey numbers do not ship uncorroborated. |
| `tweet-…-swyx-seo-automation.md` | scheduled AEO automations; $1M projection | **S53** | $1M = labelled practitioner anecdote. Measured data from the brief carries the slide. |
| `tweet-…-meta-skill-tractability.md` (Dean Ball) | the meta-skill aphorism | **S54** | Opinion, quotable, attributed. Note his OpenAI affiliation. |
...
|-------------|---------------|-------|
| run `frontier-evaluations` | **S07** (+ S08, S37 corrections) | LAUNCHED 2026-08-31, opus/high |
| run `orchestration-2026` | **S31, S32, S33** (+ S34 revision) | LAUNCHED 2026-08-31, opus/high |
| brief `ai-economics-refresh` | S05, S06 | queued (cap = 2 runs) |
| brief `autonomous-rnd-evidence` | S38, S11 | queued |
| brief `company-memory-landscape` | S52 | queued |
| brief `aeo-answer-engine-optimization` | S53 | queued |
...
| `orch-*.png` (5 Anthropic pattern figures) | heuritech assets | S34 |
