...
*#TODO ADD IMAGE — customer service task table (W3 p9)*
...
*#TODO ADD IMAGE — augmentation vs automation (W3 p10)*
...
### Technical Feasibility — *L'IA peut-elle le faire ?*

- Un jeune diplômé pourrait-il suivre les instructions du prompt ?
- En cas de doute, *testez* — un AI Engineer peut évaluer RAG/Fine-tuning

</div>
<div class="right">

### Business Value — *Est-ce rentable ?*

- Combien de *temps* est consacré à cette tâche ?
- L'automatiser crée-t-elle une valeur *substantielle* ?
...
*#TODO ADD IMAGE — surgeon time reallocation bar chart (W3 p19)*
...
*#TODO ADD IMAGE — legal review workflow before/after (W3 p20)*
...
*#TODO ADD IMAGE — marketing automation workflow (W3 p21)*
...
*#TODO ADD IMAGE — customer task analysis for website building (W3 p22)*
...
1. *Sales* — ~$500Md
2. *Software Engineering* (IT + product) — ~$850Md
3. *Marketing* — ~$460Md
4. *Customer Operations* — ~$400Md
5. *Product R&D* — ~$320Md

</div>
<div class="right">

*Fonctions moins impactées* (~$50-200Md) :

- Supply Chain, Finance, Manufacturing, Legal, Procurement, Pricing

</div>

> Les fonctions *orientées contenu et communication* captent 75% de la valeur GenAI.
...
*#TODO ADD IMAGE — industry sector bar chart (W3 p30)*
...
*#TODO ADD IMAGE — RLHF reward model table (W3 p32-33)*
...
- *Privacy* — protéger les données personnelles et la confidentialité

</div>
<div class="right">

- *Security* — protéger les systèmes IA contre les attaques malveillantes
...
*#TODO ADD IMAGE — five dimensions of responsible AI (W3 p44)*
...
- Scoring social, manipulation subliminale, exploitation de vulnérabilités, biométrie temps réel

*Risque élevé* (obligations strictes)
- Recrutement, crédit/assurance, justice, éducation

</div>
<div class="right">

*Risque limité* (transparence)
- Chatbots, deepfakes, contenu IA — signaler l'utilisation d'IA

*Risque minimal* (libre) — anti-spam, jeux vidéo, majorité des apps IA
