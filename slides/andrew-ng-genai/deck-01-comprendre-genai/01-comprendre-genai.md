...
<!-- TODO: insert diagram from W1 p4 (AI mentions bar chart + stats) -->
...
<!-- TODO: insert diagram from W1 p5 (chatbot screenshots) -->
...
<!-- TODO: insert diagram from W1 p6 (Jupyter notebook screenshot) -->
...
<!-- TODO: insert diagram from W1 p8-9 (image generation examples + audio/video) -->
...
### Supervised Learning
- La **plus grande part de la valeur économique** de l'IA aujourd'hui
- **Input A → Output B** (étiquetage)
- Ex : email → spam ? image → diagnostic ?

### Unsupervised Learning
- Découverte de patterns sans labels
- Ex : segmentation clients

</div>
<div class="right">

### Generative AI
- La catégorie en **pleine explosion**
- Génère du **contenu original** à partir d'instructions
- Texte, images, audio, vidéo, code

### Reinforcement Learning
- L'agent apprend par essai/erreur
- Ex : jeux, robotique, trading

</div>

<!-- TODO: insert diagram from W1 p14 (AI categories bubble diagram) -->
...
<!-- TODO: insert diagram from W1 p17 (scaling curves: performance vs data) -->
...
<!-- TODO: insert diagram from W1 p18-19 (next-word prediction + iterative generation) -->
...
<!-- TODO: insert diagram from W1 p21 (writing partner examples) -->
...
- Trouve des **pages existantes**
- Fonctionne bien pour des requêtes **standard**
- Ex : "recette tarte aux pommes" → liens pertinents
- Limité pour les requêtes **créatives ou combinées**

</div>
<div class="right">

### LLM
- **Synthétise** une réponse sur mesure
- Excelle pour les requêtes **combinées ou créatives**
...
<!-- TODO: insert diagram from W1 p22-24 (web search vs LLM comparison) -->
...
<!-- TODO: insert diagram from W1 p26-27 (electricity analogy + supervised learning table) -->
...
<!-- TODO: insert diagram from W1 p28-29 (Writing/Reading/Chatting taxonomy + web vs app) -->
...
<!-- TODO: insert diagram from W1 p31-32 (brainstorming product names + sales strategy) -->
...
<!-- TODO: insert diagram from W1 p33-35 (press release: generic vs improved) -->
...
<!-- TODO: insert diagram from W1 p36-38 (translation examples: formal Hindi, spoken Hindi, pirate English) -->
...
<!-- TODO: insert diagram from W1 p39 (proofreading example: snuggle → snuggly) -->
...
<!-- TODO: insert diagram from W1 p40 (summarizing an article) -->
...
<!-- TODO: insert diagram from W1 p41-43 (call center pipeline: conversations → summaries → dashboard) -->
...
<!-- TODO: insert diagram from W1 p44-47 (email routing prompt anatomy — progressive improvement) -->
...
<!-- TODO: insert diagram from W1 p48 (reputation monitoring dashboard) -->
...
<!-- TODO: insert diagram from W1 p50-51 (BettaBurgers chatbot + specialized chatbots) -->
...
<!-- TODO: insert diagram from W1 p53-55 (chatbot deployment spectrum + advice) -->
...
<!-- TODO: insert diagram from W1 p57-59 (fresh college grad test — progressive examples) -->
...
<!-- TODO: insert diagram from W1 p61-62 (knowledge cutoff examples: film 2022, LK-99) -->
...
<!-- TODO: insert diagram from W1 p63-64 (hallucination examples: Shakespeare + court cases) -->
...
<!-- TODO: insert diagram from W1 p65-67 (context length limitation + chunking strategy) -->
...
- Ex : prix immobilier, historique d'achats
- **Le Supervised Learning classique est souvent meilleur**
- Les LLMs ne sont pas optimisés pour ce type de données
...
- Ex : emails, avis clients, conversations
- **C'est le terrain de jeu de la Generative AI**
- Writing, Reading, Chatting — tout repose sur des données non structurées
...
<!-- TODO: insert diagram from W1 p69-70 (structured vs unstructured data comparison) -->
...
<!-- TODO: insert diagram from W1 p71 (bias example: surgeon/nurse gender completion) -->
...
<!-- TODO: insert diagram from W1 p73 (be detailed and specific example) -->
...
<!-- TODO: insert diagram from W1 p75-76 (chain-of-thought: cat toy naming, 3-step table) -->
...
<!-- TODO: insert diagram from W1 p77 (experiment and iterate — 3 versions) -->
...
<!-- TODO: insert diagram from W1 p78 (prompt iteration cycle diagram) -->
...
<!-- TODO: insert diagram from W1 p80 (example generated images: woman, city, robot) -->
...
<!-- TODO: insert diagram from W1 p81-86 (diffusion model: apple noise sequence + watermelon denoising) -->
...
<!-- TODO: insert diagram from W1 p87-88 (adding text: caption-conditioned diffusion) -->
