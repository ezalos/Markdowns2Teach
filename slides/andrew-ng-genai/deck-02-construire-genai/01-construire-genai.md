...
<!-- TODO: insert diagram from W2 p3 (three-column app examples: Writing/Reading/Chatting) -->
...
<!-- TODO: insert diagram from W2 p6 (supervised learning workflow: Get data → Train → Deploy) -->
...
<!-- TODO: insert diagram from W2 p7 (prompt-based development: instruction + review + code) -->
...
- Collecter des données labellisées — **1 mois**
- Entraîner le modèle — **3 mois**
- Déployer le modèle — **3 mois**
- **Total : ~7 mois**
- Nécessite une équipe ML
...
<!-- TODO: insert diagram from W2 p15 (full lifecycle with feedback loops between all stages) -->
...
<!-- TODO: insert diagram from W2 p16 (iterative prompting cycle: Idea → Prompt → LLM Response) -->
...
<!-- TODO: insert diagram from W2 p13 (lifecycle showing feedback loop from Evaluate back to Build) -->
...
<!-- TODO: insert diagram from W2 p19 (four tools pyramid: Prompting → RAG → Fine-tune → Pretrain) -->
...
<!-- TODO: insert diagram from W2 p20-21 (BettaBurgers lifecycle: scope → build → evaluate with errors) -->
...
<!-- TODO: insert diagram from W2 p23 (BettaBurgers full lifecycle with deploy and monitor) -->
...
<!-- TODO: insert diagram from W2 p25 (token visualization: words split into tokens) -->
...
<!-- TODO: insert diagram from W2 p28 (General Chatbot vs. Chatbot with RAG comparison) -->
...
<!-- TODO: insert diagram from W2 p29-30 (3-step RAG process with documents, prompt, and response) -->
...
<!-- TODO: insert diagram from W2 p31-33 (RAG applications: PDF chat, web search, specialized bots) -->
...
<!-- TODO: insert diagram from W2 p36 (pretraining vs fine-tuning: data volumes and process comparison) -->
...
<!-- TODO: insert diagram from W2 p37-39 (fine-tuning for summarization style and voice mimicking) -->
...
<!-- TODO: insert diagram from W2 p41 (distillation: large model → small model with fine-tuning) -->
...
<!-- TODO: insert diagram from W2 p45 (BloombergGPT announcement) -->
...
<!-- TODO: insert diagram from W2 p48 (model size vs capabilities table) -->
...
<!-- TODO: insert diagram from W2 p54 (RLHF reward model scoring table) -->
...
<!-- TODO: insert diagram from W2 p55-56 (tool use: ORDER function call and CALCULATOR example) -->
...
<!-- TODO: insert diagram from W2 p57 (agent workflow: Search → Visit → Summarize multi-step) -->
